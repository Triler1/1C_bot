...
Функция ПолучитьЧат(ОписаниеЧата) Экспорт
...
Процедура ОтправитьВидео(Знач Получатель, Знач ДанныеВидео, Знач Текст = "", Знач ДополнительныеСвойства = Неопределено) Экспорт
	...
	ОписаниеЗапроса.Тело = СоставноеТелоОтправкаВидео(Разделитель, ИдентификаторПолучателя,
		ДанныеВидео, Текст, ДополнительныеСвойства.Клавиатура, ДополнительныеСвойства.ТипТекста);
...
Функция СоставноеТелоОтправкаВидео(Разделитель, Получатель, ДанныеВидео, Текст, Клавиатура, ParseMode)
	...
	// video
	ЗаписьДанных.ЗаписатьСтроку("--" + Разделитель);
	ЗаписьДанных.ЗаписатьСтроку("Content-disposition: form-data; name=""video""; filename=""video.mp4""");
	ЗаписьДанных.ЗаписатьСтроку("Content-Type: video/mp4");
	ЗаписьДанных.ЗаписатьСтроку("");
	ЗаписьДанных.Записать(ДанныеВидео);
	ЗаписьДанных.ЗаписатьСтроку("");
	...
	Если ЗначениеЗаполнено(Текст) Тогда
		...
		ЗаписьДанных.ЗаписатьСтроку("");
		ЗаписьДанных.ЗаписатьСтроку(ParseMode);
	КонецЕсли;
...
Функция ПрочитатьВидеоВДвоичныеДанные(ПолныйПутьКФайлу) Экспорт
	// пример: "C:\Video\intro.mp4" или сетевой путь "\\server\share\intro.mp4"
	Возврат Новый ДвоичныеДанные("C:\Video\intro.mov");
КонецФункции
